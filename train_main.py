...
training_directory = r'./dataset_management/refit/kettle/kettle_training_.csv'
training_directory = "C:\\Users\\davwang\\Desktop\\seq2point-nilm\\dataset_management\\refit\\kettle\\kettle_training_.csv"
validation_directory = r'./dataset_management/refit/kettle/kettle_validation_.csv'
validation_directory = "C:\\Users\\davwang\\Desktop\\seq2point-nilm\\dataset_management\\refit\\kettle\\kettle_validation_H5.csv"

parser = argparse.ArgumentParser(description="Train sequence-to-point learning for energy disaggregation. ")

parser.add_argument("--appliance_name", type=remove_space, default="kettle",
...
parser.add_argument("--validation_directory", type=str, default=validation_directory,
